 ...
 */
public class ReadFeedsOperation extends AbsOperation<List<News>> {
	...
	public ReadFeedsOperation(Context c, OperationListener listener, int universityId, int page, int totalSize) {
		super(c, listener);
